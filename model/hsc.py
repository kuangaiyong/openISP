...
class HSC:
    ...
    def execute(self):
        ...
        hsc_img[:,:,0] = (self.img[:,:,0] - 128) * lut_cos[self.hue] / 256 + (self.img[:,:,1] - 128) * lut_sin[self.hue] / 256 + 128
        hsc_img[:,:,1] = (self.img[:,:,1] - 128) * lut_cos[self.hue] / 256 - (self.img[:,:,0] - 128) * lut_sin[self.hue] / 256 + 128
